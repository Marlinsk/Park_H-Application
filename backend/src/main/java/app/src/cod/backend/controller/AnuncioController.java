...
public class AnuncioController {
	...
	@GetMapping("/")
	public ResponseEntity<Page<Anuncio>> buscarTodosAnuncios(@PageableDefault(page = 0, size = 10, sort = "id", direction = Sort.Direction.ASC) Pageable pageable) {
		return ResponseEntity.status(HttpStatus.OK).body(anuncioService.findAll(pageable));
	}
