...
import app.prod.src.backend_user.extraclass.extraclasses;

@DynamoDBTable(tableName = "user")
public class user extends extraclasses {
	...
	public user(String fullname, Date birthdate, String statename, String cityname, String email,
			String password) {
		super();
	...
	public String toString() {
		return "user data [id: " + id + ", full name: " + fullname + ", birth date: "
